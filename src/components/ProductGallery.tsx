...
const products = [
  ...
  { id: 3, src: product3, alt: "BohemianClo — Pure white oversized tee with relaxed fit, complemented by crisp white BohemianClo skull cap and olive-grey tactical camo cargo pants with custom patches" },
  { id: 4, src: product4, alt: "BohemianClo — Collective campaign featuring signature white oversized tees, monochrome BohemianClo skull caps, and military-inspired camo bottoms, outdoor lifestyle aesthetic" },
